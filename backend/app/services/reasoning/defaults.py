...
US2_CLASSIFICATION_CRITERIA: list[ClassificationCriterion] = [
    ...
    ClassificationCriterion(
        ...
        description=(
            "API aligns to ChEBI:35610 antineoplastic agent → AntineoplasticDrug (new class)"
        ),
    ),
]
...
_EQUIPMENT_DEDICATION_RULES: list[DecisionRule] = [
    ...
    DecisionRule(
        ...
        description=(
            "Cytotoxic drug with validated inactivation → shared line allowed with conditions"
        ),
    ),
    DecisionRule(
        key="R-ED5",
...
_SCENARIO_RULES: list[DecisionRule] = [
    ...
    DecisionRule(
        ...
        consequent={
            "scenario": "TerminalVsNonTerminalSterilizationScenario",
