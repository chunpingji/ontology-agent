"""Evaluation-only atomic source citations and conservative verification projection.
...
from app.services.extraction.extraction_tasks import GenericExtractionRunner, SpanProposal
...
class CitationProtocol:
    ...
    def _span(self, value, path):
        ...
        anchor = GenericExtractionRunner._anchor(proposal, self.ir, allowed)
        return {
